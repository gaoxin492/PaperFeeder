...
class ResolutionResult:
    ...
    resolution_status: str = "unresolved"  # existing|resolved|unresolved|error
    resolution_method: str = "none"  # existing|arxiv_id|title_search|none
    error: str = ""
...
class SemanticPaperResolver:
    ...
    def _budget_exhausted(self) -> bool:
        ...
        if hard_cap > 0 and self._stats.lookups_attempted >= hard_cap:
            return True
        return False
        ...
        *,
        ...
        if aid:
            ...
            if mapped:
                return mapped
        if title:
            by_title = self._lookup_by_title(
                title=title,
                paper_year=paper_year,
    ...
    def _accept_title_candidate(
        ...
        *,
        ...
        # Secondary consistency check: year proximity OR author overlap.
        year_ok = False
        ...
        if author_names:
            ...
            cand_authors = {
                _normalize_title_for_match(str(a.get("name", "")))
